...
public class AuthController {
    ...
    @ApiResponses(value = {
        ...
        @SwaggerApiResponse(responseCode = "400", description = "Bad Request - Invalid input or username/email already exists"),
        @SwaggerApiResponse(responseCode = "422", description = "Validation error - Check request body fields")
    })
    ...
    @ApiResponses(value = {
        @SwaggerApiResponse(responseCode = "200", description = "Login successful",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = ApiResponse.class))),
        @SwaggerApiResponse(responseCode = "401", description = "Unauthorized - Invalid credentials"),
        @SwaggerApiResponse(responseCode = "400", description = "Bad Request - Missing required fields")
    })
